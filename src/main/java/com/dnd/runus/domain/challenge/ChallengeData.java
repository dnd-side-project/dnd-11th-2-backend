...
public record ChallengeData(Challenge challengeInfo, List<ChallengeCondition> challengeConditions) {
    public record Challenge(
            long challengeId, String name, String expectedTime, String imageUrl, ChallengeType challengeType) {
        public Challenge(
                long challengeId, String name, int expectedTime, String imageUrl, ChallengeType challengeType) {
